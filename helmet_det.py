...
#  Argument Parser
def parse_args():
    parser = argparse.ArgumentParser(description="Helmet Detection using YOLOv5")
    parser.add_argument("--weights", type=str, required=True, help="Path to helmet model weights (.pt)")
